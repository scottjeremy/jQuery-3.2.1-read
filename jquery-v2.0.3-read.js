 ...
 * 为什么要传window进形参呢？
 *因为涉及到了查询的速度，在自执行函数里查外部的window会比查形参的window要慢
 *还有代码压缩的时候会把window压缩成w，从而识别不了
 */
...
//"use strict";
    var
    // A central reference to the root jQuery(document) jquery获取document
        rootjQuery,
    ...
    // For `typeof xmlNode.method` instead of `xmlNode.method !== undefined`
        //存一个字符串的undefined  XML的情况下直接使用 == undefined会出现证据不足而导致BUG
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        constructor: jQuery,
        //第一个selector参数是选择器，第二个context是作用域
                ...
                * */
                ...
                if ( match && (match[1] || !context) ) {
                    ...
                    if ( match[1] ) {
                        ...
                        //merge第三个参数为bollean scripts 是否能执行
